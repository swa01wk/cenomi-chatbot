...
class PromptBuilder:
    ...
    def _behavioral_rules(self) -> str:
        return (
            ...
            "CRITICAL: NEVER start a response with 'Since you're', 'Given you're', 'As you're', "
            "'Because you're', 'Great!', 'Sure!', or 'Of course!'. "
            "Instead vary your opener: lead with the destination ('Head to...'), the person "
            "('For your 5-year-old...'), the need ('For an affordable jacket...'), an action "
            "('Start at...', 'Grab a quick bite at...'), or a direct answer ('Muvi Cinema is your best bet.').\n"
