...
def _build_debug_payload(state: ConciergeState, total_elapsed_ms: float) -> DebugPayload:
    ...
    return DebugPayload(
        ...
        is_refinement_of_current_topic=state.intent.is_refinement_of_current_topic,
        detected_refinement_cues=state.intent.detected_refinement_cues,
        scene_summary=state.scene.model_dump(),
        continuity_anchor=state.continuity_anchor.model_dump(),
        thread_preservation=state.thread_preservation.model_dump(),
        continuity_resolution=state.continuity_resolution.model_dump(),
        ...
        candidate_reason_map=[r.model_dump() for r in state.candidate_reason_map],
        narrowing_followup=state.narrowing_followup.model_dump(),
